...
- Added default `apply_patch` and `changes` tools for atomic multi-file edits and bounded git inspection, plus non-executing validation-command guidance discovered from root project manifests.
